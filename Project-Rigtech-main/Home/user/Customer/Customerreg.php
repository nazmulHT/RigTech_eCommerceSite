...
<h3>Personal Details</h3>
 ...
 <B>First Name:</b> <input type="text" name="name" placeholder="Enter First Name" value="<?php echo $name;?>">
  ...
  <B>Last Name:</b> <input type="text" lastname="lastname" placeholder="Enter Last Name" value="<?php echo $lastname;?>">
  <span class="error">* <?php echo $lastnameErr;?></span>
  <br><br>
  <B>User Name:</b> <input type="text" username="username" placeholder="Enter Username" value="<?php echo $username;?>">
